...
export function processSaarthiMessage({
  ...
  // Case C: Initial greeting response (Asking Name or Business Idea)
    ...
    if (extracted.entrepreneurName) {
      ...
      responseText = language === 'hi'
        ? "नमस्ते! मैं सारथी हूँ, आपका व्यावसायिक साथी। आगे बढ़ने से पहले, क्या मैं आपका शुभ नाम जान सकता हूँ?"
        : (language === 'te'
          ? "నమస్తే! నేను సారథిని, మీ వ్యాపార తోడు. ప్రారంభించే ముందు, మీ పేరు తెలుసుకోవచ్చా?"
          : "Hello! I'm Saarthi, your rural business companion. Before we begin, may I know your name?");
    }
  }
